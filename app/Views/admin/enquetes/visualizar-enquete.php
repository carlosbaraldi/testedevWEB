  ...
  <div class="row my-2">
    <div class="col-sm-12">
      <div class="form-group box" id="box">
        ...
        <div class="card ">
          <h5 class="card-header text-center">TITULO: <strong><?php echo $enquete['tituloEnquete'] ?></strong></h5>
          <div class="card-body">
            <h5 class="card-title text-center">PERGUNTA: <strong> <?php echo ($enquete['perguntaEnquete']) ?> </strong></h5>
          </div>
