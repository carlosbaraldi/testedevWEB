<header class="navbar navbar-dark  sticky-top bg-primary  flex-md-nowrap p-0 ">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/home/index">Teste Desenvolvedor WEB</a>
  ...
  <div class="navbar-nav bg-danger">
    <div class="nav-item ">
      <a class="px-3 btn btn-danger btn-lg" href="/entrar/signOut">SAIR</a>
    </div>
  </div>
</header>
